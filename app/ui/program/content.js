    ...
    return (
        <section className="flex flex-col px-4 py-8 mt-10 text-black bg-amber-400 rounded-3xl lg:w-5/6 ">
            <div className="flex-shrink-0">
                ...
                <p className="mt-3.5 ml-3.5 text-base lg:text-lg md:pb-10 ">{description}</p>
            </div>
            <div className="flex flex-wrap  justify-between self-center px-10 py-1 mt-11 max-w-full text-sm lg:text-lg text-white rounded-3xl bg-slate-900 w-[400px]">
...
function ProgramsContent() {
    return (
        <main className="flex flex-col px-10 md:px-2  lg:px-72 mt-6 md:mt-20 ">
